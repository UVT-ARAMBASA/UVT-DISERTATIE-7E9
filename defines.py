...
MULTI_MATRIX_C_RE_N = 16  # FASTER MULTI RES # WAS 256 and then 64 (at 64 crashed)
MULTI_MATRIX_C_IM_N = 16  # FASTER MULTI RES # WAS 256 and then 64 (at 64 crashed)